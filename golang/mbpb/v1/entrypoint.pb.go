...
var file_entrypoint_proto_rawDesc = []byte{
	...
	0x0a, 0x05, 0x5f, 0x4f, 0x76, 0x65, 0x72, 0x22, 0x3a, 0x0a, 0x04, 0x4f, 0x76, 0x65, 0x72, 0x12,
	0x12, 0x0a, 0x04, 0x48, 0x61, 0x73, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x48,
	0x61, 0x73, 0x68, 0x12, 0x1e, 0x0a, 0x0a, 0x53, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x65, 0x49,
	0x44, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x53, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63,
	0x65, 0x49, 0x44, 0x22, 0xb4, 0x01, 0x0a, 0x05, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x15, 0x0a,
	...
	0x09, 0x52, 0x03, 0x4d, 0x73, 0x67, 0x2a, 0x64, 0x0a, 0x09, 0x52, 0x75, 0x6e, 0x53, 0x74, 0x61,
	...
	0x32, 0xb1, 0x01, 0x0a, 0x05, 0x4d, 0x42, 0x65, 0x74, 0x6c, 0x12, 0x32, 0x0a, 0x06, 0x45, 0x6e,
	...
	0x6c, 0x79, 0x22, 0x00, 0x42, 0x52, 0x0a, 0x14, 0x63, 0x6f, 0x6d, 0x2e, 0x6f, 0x74, 0x6f, 0x72,
	0x70, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x42, 0x0c, 0x4d, 0x42,
	0x45, 0x74, 0x6c, 0x70, 0x62, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x00, 0x5a, 0x2a, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x66, 0x6f, 0x72, 0x68, 0x73, 0x64, 0x2f,
	0x6d, 0x62, 0x70, 0x62, 0x2f, 0x67, 0x6f, 0x6c, 0x61, 0x6e, 0x67, 0x2f, 0x6d, 0x62, 0x70, 0x62,
	0x2f, 0x76, 0x31, 0x3b, 0x6d, 0x62, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_entrypoint_proto_goTypes = []interface{}{
	...
	(*Over)(nil),                  // 8: mbpb.Over
	(*Reply)(nil),                 // 9: mbpb.Reply
	(*Table)(nil),                 // 10: mbpb.Table
	(*Column)(nil),                // 11: mbpb.Column
	(*DBDetail)(nil),              // 12: mbpb.DBDetail
	(*CycleOnce)(nil),             // 13: mbpb.CycleOnce
	(*CycleEvery)(nil),            // 14: mbpb.CycleEvery
	(*CycleEveryTime)(nil),        // 15: mbpb.CycleEveryTime
	(*EveryExpress)(nil),          // 16: mbpb.EveryExpress
	(*Expression)(nil),            // 17: mbpb.Expression
	(*CycleEveryDay)(nil),         // 18: mbpb.CycleEveryDay
	(*CycleEveryWeek)(nil),        // 19: mbpb.CycleEveryWeek
	(*CycleEveryMonth)(nil),       // 20: mbpb.CycleEveryMonth
	(*WithMonth)(nil),             // 21: mbpb.WithMonth
	(*CycleEveryYear)(nil),        // 22: mbpb.CycleEveryYear
	(*WithQuarter)(nil),           // 23: mbpb.WithQuarter
	(*CycleEveryQuarter)(nil),     // 24: mbpb.CycleEveryQuarter
	(*CycleHour)(nil),             // 25: mbpb.CycleHour
	(*LifeCycle)(nil),             // 26: mbpb.LifeCycle
	(*Crontab)(nil),               // 27: mbpb.Crontab
	(*FQN)(nil),                   // 28: mbpb.FQN
	(*Extra)(nil),                 // 29: mbpb.Extra
	(*Error)(nil),                 // 30: mbpb.Error
	nil,                           // 31: mbpb.DBDetail.ConnectParamsEntry
	(*timestamppb.Timestamp)(nil), // 32: google.protobuf.Timestamp
}
var file_entrypoint_proto_depIdxs = []int32{
	12, // 0: mbpb.EnableRequest.DBInfo:type_name -> mbpb.DBDetail
	27, // 1: mbpb.EnableRequest.Crontab:type_name -> mbpb.Crontab
	10, // 2: mbpb.EnableRequest.Tables:type_name -> mbpb.Table
	29, // 3: mbpb.EnableRequest.Extra:type_name -> mbpb.Extra
	8,  // 4: mbpb.EnableRequest.Over:type_name -> mbpb.Over
	10, // 5: mbpb.EnableReply.OutTable:type_name -> mbpb.Table
	11, // 6: mbpb.EnableReply.Columns:type_name -> mbpb.Column
	32, // 7: mbpb.EnableReply.NextRunTime:type_name -> google.protobuf.Timestamp
	30, // 8: mbpb.EnableReply.Error:type_name -> mbpb.Error
	8,  // 9: mbpb.Request.Over:type_name -> mbpb.Over
	11, // 10: mbpb.Reply.Columns:type_name -> mbpb.Column
	30, // 11: mbpb.Reply.Error:type_name -> mbpb.Error
	31, // 12: mbpb.DBDetail.ConnectParams:type_name -> mbpb.DBDetail.ConnectParamsEntry
	17, // 13: mbpb.CycleOnce.Expression:type_name -> mbpb.Expression
	16, // 14: mbpb.CycleEvery.EveryExpress:type_name -> mbpb.EveryExpress
	17, // 15: mbpb.CycleEvery.Expression:type_name -> mbpb.Expression
	4,  // 16: mbpb.CycleEveryTime.EveryType:type_name -> mbpb.EveryTimeType
	25, // 17: mbpb.CycleEveryTime.RunTime:type_name -> mbpb.CycleHour
	18, // 18: mbpb.CycleEveryTime.EveryDay:type_name -> mbpb.CycleEveryDay
	19, // 19: mbpb.CycleEveryTime.EveryWeek:type_name -> mbpb.CycleEveryWeek
	20, // 20: mbpb.CycleEveryTime.EveryMonth:type_name -> mbpb.CycleEveryMonth
	24, // 21: mbpb.CycleEveryTime.EveryQuarter:type_name -> mbpb.CycleEveryQuarter
	22, // 22: mbpb.CycleEveryTime.EveryYear:type_name -> mbpb.CycleEveryYear
	...
	21, // 26: mbpb.CycleEveryYear.Month:type_name -> mbpb.WithMonth
	23, // 27: mbpb.CycleEveryQuarter.Month:type_name -> mbpb.WithQuarter
	26, // 28: mbpb.Crontab.LifeCycle:type_name -> mbpb.LifeCycle
	13, // 29: mbpb.Crontab.CycleOnce:type_name -> mbpb.CycleOnce
	14, // 30: mbpb.Crontab.CycleEvery:type_name -> mbpb.CycleEvery
	15, // 31: mbpb.Crontab.CycleEveryTime:type_name -> mbpb.CycleEveryTime
	28, // 32: mbpb.Extra.Grouping:type_name -> mbpb.FQN
	28, // 33: mbpb.Extra.Selects:type_name -> mbpb.FQN
	...
	9,  // 39: mbpb.MBetl.Disable:output_type -> mbpb.Reply
	9,  // 40: mbpb.MBetl.Run:output_type -> mbpb.Reply
	9,  // 41: mbpb.MBetl.Cancel:output_type -> mbpb.Reply
